...
namespace KURSOVA
{
    public partial class AddFlightForm : Form
    {
        ...
        public AddFlightForm(BookingManager booking)
        {
            InitializeComponent();
            this.KeyPreview = true;
           this.bookingManager = booking;
        }
        ...
        private void btnAddFlight_Click(object sender, EventArgs e)
        {
                ...
                if (bookingManager.Schedule.Flights.Any(f => f.FlightNumber == flightNumber))
                {
                ...
                bookingManager.Schedule.AddFlight(flight);
